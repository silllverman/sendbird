import type { ComponentType, ForwardRefExoticComponent, PropsWithChildren, PropsWithoutRef, RefAttributes } from 'react';
...
export type EnhancedScrollViewAbstraction<T> = ForwardRefExoticComponent<PropsWithoutRef<EnhancedScrollViewProps> & RefAttributes<T>>;
