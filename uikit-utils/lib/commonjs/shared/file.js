...
exports.getDownscaleSize = getDownscaleSize;
exports.getFileExtension = getFileExtension;
exports.getFileExtensionFromMime = getFileExtensionFromMime;
exports.getFileExtensionFromUri = getFileExtensionFromUri;
exports.getFileType = void 0;
exports.getMimeFromFileExtension = getMimeFromFileExtension;
exports.imageExtRegex = void 0;
exports.isImage = isImage;
exports.normalizeFileName = normalizeFileName;
exports.parseMimeType = parseMimeType;
exports.shouldCompressImage = shouldCompressImage;
...
function getDownscaleSize(origin, resizing) {
  let ratio;
 ...
 */
function getMimeFromFileExtension(ext) {
  if (!ext) return '';
...
function shouldCompressImage(mime) {
