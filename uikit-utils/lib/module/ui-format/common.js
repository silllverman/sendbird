 ...
 * @returns {string}
 * */
export const truncatedCount = function (count) {
 ...
 * @returns {string}
 * */
export const getDateSeparatorFormat = (date, locale) => {
 ...
 * @returns {string}
 * */
export const getMessageTimeFormat = (date, locale) => {
 ...
 * */
export const getMessagePreviewTitle = function (message) {
 ...
 * */
export const getMessagePreviewBody = function (message) {
 ...
 * */
export const getMessagePreviewTime = (timestamp, locale) => {
