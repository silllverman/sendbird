...
const createGroupChannelFragment = (initModule?: Partial<GroupChannelModule>): GroupChannelFragment => {
  ...
  return ({
    ...
    const MessageComponent: GroupChannelProps['MessageList']['renderMessage'] = useCallback(
      withFocusingAnimation(
        renderMessage
          ? (props) => {
              props.onPressMessageAvatar = onPressMessageAvatar;
              return renderMessage({ ...props, onPressMessageAvatar });
            }
          : (props) => <MessageRenderer {...props} onPressMessageAvatar={onPressMessageAvatar} />,
      ),
      [renderMessage, onPressMessageAvatar],
    );
      ...
      >
        ...
        <StatusComposition loading={loading} LoadingComponent={<GroupChannelModule.StatusLoading />}>
          <GroupChannelModule.MessageList
            ...
            onPressMessageAvatar={onPressMessageAvatar}
