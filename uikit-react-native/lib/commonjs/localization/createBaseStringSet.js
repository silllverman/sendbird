...
exports.createBaseStringSet = void 0;
 ...
 * */
const createBaseStringSet = _ref => {
  ...
  return {
    OPEN_CHANNEL: {
      HEADER_TITLE: channel => (0, _uikitUtils.getOpenChannelTitle)(channel),
      HEADER_SUBTITLE: channel => (0, _uikitUtils.getOpenChannelParticipants)(channel),
    ...
    OPEN_CHANNEL_LIST: {
      ...
      CHANNEL_PREVIEW_TITLE: channel => (0, _uikitUtils.getOpenChannelTitle)(channel),
    ...
    GROUP_CHANNEL: {
      HEADER_TITLE: (uid, channel) => (0, _uikitUtils.getGroupChannelTitle)(uid, channel, USER_NO_NAME, CHANNEL_NO_MEMBERS),
      LIST_DATE_SEPARATOR: (date, locale) => (0, _uikitUtils.getDateSeparatorFormat)(date, locale ?? dateLocale),
    ...
    GROUP_CHANNEL_LIST: {
      HEADER_TITLE: 'Channels',
      CHANNEL_PREVIEW_TITLE: (currentUserId, channel) => (0, _uikitUtils.getGroupChannelTitle)(currentUserId, channel, USER_NO_NAME, CHANNEL_NO_MEMBERS),
      CHANNEL_PREVIEW_TITLE_CAPTION: (channel, locale) => (0, _uikitUtils.getGroupChannelPreviewTime)(channel, locale ?? dateLocale),
      CHANNEL_PREVIEW_BODY: channel => (0, _uikitUtils.getGroupChannelLastMessage)(channel),
      ...
      DIALOG_CHANNEL_TITLE: (currentUserId, channel) => (0, _uikitUtils.getGroupChannelTitle)(currentUserId, channel, USER_NO_NAME, CHANNEL_NO_MEMBERS),
    ...
    MESSAGE_SEARCH: {
      ...
      HEADER_RIGHT: 'Search',
      SEARCH_RESULT_ITEM_TITLE: message => (0, _uikitUtils.getMessagePreviewTitle)(message),
      SEARCH_RESULT_ITEM_BODY: message => (0, _uikitUtils.getMessagePreviewBody)(message),
      SEARCH_RESULT_ITEM_TITLE_CAPTION: (message, locale) => {
        return (0, _uikitUtils.getMessagePreviewTime)(message.createdAt, locale ?? dateLocale);
      }
    },
    LABELS: {
...
exports.createBaseStringSet = createBaseStringSet;
