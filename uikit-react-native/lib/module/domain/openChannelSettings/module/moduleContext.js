...
import { NOOP, isDifferentChannel, useForceUpdate, useUniqHandlerId } from '@sendbird/uikit-utils';
import ProviderLayout from '../../../components/ProviderLayout';
import { useLocalization, usePlatformService, useSendbirdChat } from '../../../hooks/useContext';
import SBUError from '../../../libs/SBUError';
import SBUUtils from '../../../libs/SBUUtils';
export const OpenChannelSettingsContexts = {
...
export const OpenChannelSettingsContextsProvider = _ref => {
  let {
    channel,
  ...
  return /*#__PURE__*/React.createElement(ProviderLayout, null, /*#__PURE__*/React.createElement(OpenChannelSettingsContexts.Fragment.Provider, {
    value: {
      channel,
