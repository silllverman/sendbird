...
export interface GroupChannelProps {
    Fragment: {
        ...
        onPressMessageAvatar: GroupChannelProps['MessageList']['onPressMessageAvatar'];
    ...
    MessageList: Pick<ChannelMessageListProps<SendbirdGroupChannel>, 'enableMessageGrouping' | 'currentUserId' | 'channel' | 'messages' | 'newMessages' | 'scrolledAwayFromBottom' | 'onScrolledAwayFromBottom' | 'onTopReached' | 'onBottomReached' | 'onResendFailedMessage' | 'onDeleteMessage' | 'onPressMediaMessage' | 'renderMessage' | 'renderNewMessagesButton' | 'renderScrollToBottomButton' | 'flatListProps' | 'onPressImageMessage' | 'hasNext' | 'searchItem'> & {
    ...
    Input: Pick<ChannelInputProps, 'shouldRenderInput' | 'onPressSendUserMessage' | 'onPressSendFileMessage' | 'onPressUpdateUserMessage' | 'onPressUpdateFileMessage' | 'SuggestedMentionList' | 'onSendFileMessage' | 'onSendUserMessage' | 'onUpdateFileMessage' | 'onUpdateUserMessage'>;
